...
এখনই এক লাইন নোট করে রাখো (ধাপ ৯-এর README/scenario reproduction অংশে এবং ধাপ ১০-এর disclosure-এ কাজে লাগবে):

"Scenario 2 verify করা হয়েছে demo_bad_deploy.sh দিয়ে — bad task s1ghyeivjuat7db9l2yp3grq5 unhealthy detect হয়ে kill হয়, Swarm auto-rollback করে, curl /health এবং smoke test দিয়ে recovery confirm করা হয়েছে।"
